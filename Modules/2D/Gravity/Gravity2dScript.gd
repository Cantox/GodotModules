class_name Gravity2dModule extends Node2D
##A moudule that handles downward gravity for a [CharacterBody2D] node.
##
...
##[b]OPTIONAL[/b][br][br]
##The module used to apply the [method CharacterBody2D.move_and_slide] method.[br][br]
##Assign a [Velocity2dModule] to this parameter ONLY if you already have one in the scene tree
@export var velocity2dModule: Velocity2dModule
